...
export default function ProductsPage() {
  return (
    <AppShell>
      <PageHeader 
        title="Shop Our Glam Essentials"
        description="Bring the Born2bBeautiful experience home with our handpicked selection of premium beauty products. Shine bright every day!"
      />
